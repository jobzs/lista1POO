...
//a soma dos que sao primos. 
        ...
        int n, divisores = 2, primo, soma = 0, conf = 1;
        ...
        System.out.printf("Deseja continuar digitando mais numeros?\n");
        System.out.printf("A soma até o momento de numeros primos e: %d\n", soma);
        System.out.printf("Senao aperte 0 para encerrar");
        conf = ler.nextInt();
        }
